...
configfile='keras_train_continue_config.json'
...
estimator = load_model('{}.h5'.format(save_file))
...
save_keras = os.path.expanduser(save_file+'new.h5')
save_json = os.path.expanduser(save_file+'new.json')
